...
const ManageCustomPickupScreen: React.FC = () => {
  ...
  const fetchRequests = useCallback(async () => {
    ...
    setError(null);
    try {
  const response = await axios.get(`${API_URL}/custompickups`);
  ...
  const handlePayment = async (id: string) => {
    ...
    try {
  await axios.put(`${API_URL}/custompickups/${id}/pay`);
  ...
  const handleMarkCompleted = async (id: string) => {
    ...
    try {
  await axios.put(`${API_URL}/custompickups/${id}/complete`);
  ...
  const handleCancelRequest = async (id: string) => {
    ...
    try {
  await axios.put(`${API_URL}/custompickups/${id}/cancel`);
